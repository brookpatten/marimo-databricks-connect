...
const S = `
  ...
  *{box-sizing:border-box}
  ...
  :host(.dark-theme) .op-state-ready {background:#064e3b;color:#6ee7b7}:host(.dark-theme) .op-state-notready {background:#78350f;color:#fcd34d}:host(.dark-theme) .op-state-unknown {background:#374151;color:#9ca3af}
